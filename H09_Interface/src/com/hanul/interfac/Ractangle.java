...
public class Ractangle extends Shape implements IShape{//Shape걸 상속 받았고 IShape 구현

	int length;//밑변
	
	//생성자:상속과 관련된 상속자임
	public Ractangle(int high,int length) {
		super(high);
		this.length = length;
	}
	...
	@Override
	public void getArea() {
		System.out.printf("높이 %d 밑변 %d인 직각사각형의 넓이는 %d이다.\n"
